 ...
 *
 * - Default mode is `neutral` (brand-safe while Expedia partnership
 ...
 *   Viator / Airbnb / Expedia / Hotelbeds / GetYourGuide).
...
const PROVIDER_IDS = ['expedia', 'vrbo', 'hotels-com', 'expedia', 'viator'] as const;
