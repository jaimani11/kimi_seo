 ...
 * outbound link on gotript belongs in the Viator ecosystem.
 *
 ...
 * is what gotript is actually monetizing.
 *
 * Affiliate model:
 *
 ...
 *     by surface (we use a fixed `gotript-stay` so stay-CTA clicks
...
/**
 * Default mcid. Surfaces the click as coming from a gotript "stay"
 ...
 */
const DEFAULT_MCID = 'gotript-stay';
 ...
 *     text=Agra&pid=PARTNER&mcid=gotript-stay&medium=link
 *
