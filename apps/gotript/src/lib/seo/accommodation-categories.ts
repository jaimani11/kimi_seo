 ...
 * gotript. Each ranks for its category-level search intent
 ...
 * Until then, they live inside gotript so we don't spread SEO
...
export const ACCOMMODATION_CATEGORIES: readonly AccommodationCategory[] = [
  {
    ...
    emoji: '🏛️',
    intro:
      'Private villa rentals — from a 2-bedroom Tuscan farmhouse to a 12-bedroom estate in Mykonos with a full staff on call. Every villa on gotript is bookable through Expedia + VRBO, with real photos and verified guest reviews. Best-fit destinations: Italy (Tuscany, Puglia, Amalfi), Greek islands, Bali, Provence, and the Caribbean.',
    searchAnchor: 'villa',
    topCitySlugs: [
      'santorini',
      'mykonos',
  ...
  },
  {
    ...
    emoji: '🏖️',
    intro:
      'Beach house rentals steps from the ocean — Outer Banks porches, Malibu decks, Amalfi terraces, or a cabana in Tulum. Every house on gotript is bookable through VRBO + Expedia with verified guest reviews. Best-fit destinations: Outer Banks, 30A, Cape Cod, Malibu, Costa Rica, Tulum, Amalfi, Positano.',
  ...
  },
  {
    ...
    emoji: '🥂',
    intro:
      'The top tier of villa rentals — private chefs, daily housekeeping, infinity pools and concierge teams. These are the homes people book for milestone trips and multi-family getaways. Every property is bookable through VRBO + Expedia with verified reviews. Best-fit destinations: Santorini, Mykonos, Bali, the Côte d\'Azur, Lake Como, and Marrakech.',
