...
export const ACCOMMODATION_CATEGORIES: readonly AccommodationCategory[] = [
  ...
  },
  {
    ...
    emoji: '🏖️',
    intro:
      'Beach house rentals steps from the ocean — Outer Banks porches, Malibu decks, Amalfi terraces, or a cabana in Tulum. Every house on gotript is bookable through VRBO + Expedia with verified guest reviews and free cancellation on most stays. Best-fit destinations: Outer Banks, 30A, Cape Cod, Malibu, Costa Rica, Tulum, Amalfi, Positano.',
