  ...
  pinterest: [
    {
      ...
      visualConcept:
        'Aerial of Shibuya Crossing at dusk with neon trails, overlay text "3 DAYS IN TOKYO" in gotript coral.',
      hashtags: ['#tokyo', '#tokyotravel', '#japan', '#3dayitinerary', '#gotript'],
      cta: 'Plan your 3-day Tokyo trip free on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoitinerary', '#japantravel', '#5days', '#gotript'],
      cta: 'Get the 5-day plan on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoweek', '#japan', '#7dayitinerary', '#gotript'],
      cta: 'Build your week-long Tokyo plan on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#cherryblossom', '#travelplanning', '#gotript'],
      cta: 'See the full Tokyo seasonal guide on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#budgettravel', '#japanbudget', '#travelhacks', '#gotript'],
      cta: 'Compare Tokyo budgets on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#foodie', '#gotript'],
      cta: 'Get the Tokyo food map free on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      visualConcept:
        'Stylized Tokyo map with four neighborhoods highlighted in gotript brand colors, each with an icon.',
      hashtags: ['#tokyo', '#wheretostay', '#tokyohotels', '#neighborhoodguide', '#gotript'],
      cta: 'Compare Tokyo neighborhoods on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#familytravel', '#tokyowithkids', '#travelwithkids', '#gotript'],
      cta: 'Plan your Tokyo family trip on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#tokyoweekend', '#gotript'],
      cta: 'Plan a Tokyo couples weekend on gotript.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#solotravel', '#solofemaletravel', '#tokyosolo', '#gotript'],
      cta: 'Plan your solo Tokyo trip on gotript.com',
    },
  ],
  tiktok: [
    {
      ...
      cta: 'Save this and plan free on gotript.com — link in bio.',
      durationSec: 22,
    ...
    },
    {
      ...
      cta: 'Free Tokyo day-1 plan at gotript.com — link in bio.',
      durationSec: 26,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyo', '#tokyovlog', '#japan', '#travelpov', '#dayinthelife', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Compare them in detail on gotript.com — link in bio.',
      durationSec: 24,
      musicCue: 'high-energy electronic, festival vibe',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#wheretostay', '#tokyohotels', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Pick your tier on gotript.com — link in bio.',
      durationSec: 20,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#tokyobudget', '#budgettravel', '#travelmoney', '#japan', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Save this crawl. Link in bio — gotript.com.',
      durationSec: 28,
      musicCue: 'upbeat j-pop instrumental',
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#streetfood', '#foodcrawl', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the solo Tokyo plan on gotript.com — link in bio.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#tokyo', '#solotravel', '#tokyosolo', '#solofemaletraveler', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Family Tokyo plan free on gotript.com — link in bio.',
      durationSec: 22,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelwithkids', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Plan + book on gotript.com — link in bio.',
      durationSec: 18,
      musicCue: 'tense uplifting electronic',
      hashtags: ['#tokyo', '#travelplanning', '#tokyohacks', '#traveltips', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the perfect Tokyo day on gotript.com — link in bio.',
      durationSec: 20,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#tokyonight', '#tokyodawn', '#travelvideo', '#gotript'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get smart Tokyo tips on gotript.com — link in bio.',
      durationSec: 22,
      musicCue: 'punchy lo-fi with vocal sample',
      hashtags: ['#tokyo', '#travelmistakes', '#tokyotips', '#travelhacks', '#gotript'],
    },
  ],
  reels: [
    {
      ...
      cta: 'Full Tokyo plan on gotript.com.',
      durationSec: 28,
      musicCue: 'dreamy indie-pop, mid-tempo',
      hashtags: ['#tokyo', '#tokyoreels', '#japan', '#travelreels', '#travelinspo', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo food map on gotript.com.',
      durationSec: 26,
      musicCue: 'jazzy lounge, food-show energy',
      hashtags: ['#tokyofood', '#japanfood', '#foodreels', '#tokyoeats', '#foodie', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'See the full seasonal guide on gotript.com.',
      durationSec: 18,
    ...
    },
    {
      ...
      durationSec: 22,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyohotels', '#wheretostay', '#tokyoneighborhoods', '#travelreels', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Plan the perfect Tokyo Sunday on gotript.com.',
      durationSec: 30,
      musicCue: 'mellow jazz, café ambience',
      hashtags: ['#tokyo', '#tokyovlog', '#travelreels', '#sundayintokyo', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Family Tokyo plan on gotript.com.',
      durationSec: 24,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelreels', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Romantic Tokyo weekend on gotript.com.',
      durationSec: 26,
      musicCue: 'soft piano, romantic',
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#travelreels', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Solo Tokyo plan on gotript.com.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#solofemaletravel', '#tokyosolo', '#solotravel', '#travelreels', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo prep checklist on gotript.com.',
      durationSec: 18,
      musicCue: 'punchy lo-fi',
      hashtags: ['#tokyo', '#packingtips', '#travelpacking', '#travelreels', '#gotript'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Save and plan on gotript.com.',
      durationSec: 22,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#goldenhour', '#tokyoview', '#travelreels', '#travelinspo', '#gotript'],
    },
  ],
  shorts: [
    {
      ...
      cta: 'Get the full 3-day Tokyo plan free on gotript.com.',
      durationSec: 28,
      musicCue: 'uplifting cinematic electronic',
      hashtags: ['#tokyo', '#tokyoitinerary', '#travelshorts', '#japanshorts', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Budget Tokyo plan free on gotript.com.',
      durationSec: 22,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#budgettravel', '#travelshorts', '#tokyobudget', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pick your Tokyo neighborhood on gotript.com.',
      durationSec: 24,
      musicCue: 'punchy upbeat lo-fi',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#travelshorts', '#japan', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#travelmistakes', '#travelshorts', '#tokyotips', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Full Tokyo food map on gotript.com.',
      durationSec: 26,
      musicCue: 'food-show jazzy lounge',
      hashtags: ['#tokyofood', '#tokyo', '#travelshorts', '#japanfood', '#foodtok', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#travelshorts', '#travelplanning', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Book a Tokyo day trip on gotript.com.',
      durationSec: 22,
      musicCue: 'uplifting cinematic',
      hashtags: ['#tokyo', '#daytrips', '#travelshorts', '#hakone', '#kamakura', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Free Tokyo plan on gotript.com.',
      durationSec: 18,
      musicCue: 'punchy uplifting electronic',
      hashtags: ['#tokyo', '#freetokyo', '#budgettravel', '#travelshorts', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Local Tokyo food guide on gotript.com.',
      durationSec: 18,
      musicCue: 'mellow lo-fi',
      hashtags: ['#tokyofood', '#localtokyo', '#travelshorts', '#tokyo', '#gotript'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pre-flight Tokyo checklist on gotript.com.',
      durationSec: 20,
      musicCue: 'punchy productivity beat',
      hashtags: ['#tokyo', '#travelapps', '#travelshorts', '#travelprep', '#gotript'],
    },
  ],
};
