...
/**
 * Visible breadcrumb trail. Pair with `<ExperienceJsonLd>` (or any
 * BreadcrumbList JSON-LD producer) so the user-visible trail and the
 * machine-readable trail stay in lockstep.
 *
