...
export function AgenticHero() {
  ...
  return (
    ...
    >
      {/* gotript is a Expedia affiliate. The hero band uses
       *  Expedia's iconic deep-navy → bright-blue gradient so the
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, #2a1430 0%, #3a2140 55%, #4a2c4d 100%)',
        }}
      />
