...
export const metadata: Metadata = {
  title: 'Terms of Service · gotript',
  description: 'The terms governing your use of gotript.com.',
  alternates: { canonical: 'https://www.gotript.com/terms' },
};
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        <header className="mb-10">
          ...
          >
            The agreement between you and gotript when you use this site.
          </p>
        </header>

        <Section title="1. About gotript">
          <P>
        ...
        <Section title="4. What you can't do">
          <ul style={ulStyle}>
            ...
            <Li>Impersonate gotript or its operators.</Li>
          </ul>
        </Section>
        ...
        <Section title="9. Disclaimer + limitation of liability">
          <P>
            To the maximum extent permitted by law, gotript is not liable for indirect,
        ...
        <Section title="10. Indemnification">
          <P>
            You agree to indemnify and hold gotript harmless from any claim arising out of your
        ...
        <Section title="13. Contact">
          <P>
            ...
            <a href="mailto:hello@gotript.com" style={{ color: 'var(--accent-primary)' }}>
              hello@gotript.com
            </a>
            .
          </P>
