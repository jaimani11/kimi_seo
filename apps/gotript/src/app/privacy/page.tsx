...
export const metadata: Metadata = {
  title: 'Privacy Policy · gotript',
  description:
    'How gotript collects, uses, and shares information when you use our travel-planning service.',
  alternates: { canonical: 'https://www.gotript.com/privacy' },
};
 ...
 * what gotript actually does with their data.
 *
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        ...
        <Section title="1. Who we are">
          <P>
            Gotript (&ldquo;gotript&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) operates the
        ...
        <Section title="4. Third parties we share with">
          ...
          <ul style={ulStyle}>
            <Li>
              ...
              under their own privacy policy. We do not share your gotript account information
              with them.
            </Li>
            <Li>
            ...
            <Li>
              ...
              trackers on our pages, and clicking a gotript link on those platforms simply opens
        ...
        <Section title="11. Contact">
          <P>
            ...
            <a
              href="mailto:privacy@gotript.com"
