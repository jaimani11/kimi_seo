      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-12 md:py-16">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            >
              <span
                ...
                style={{
                  ...
                  boxShadow: '0 2px 6px rgba(216, 67, 21, 0.28)',
                }}
              >
            ...
            >
              Hand-picked Viator experiences in the cities worth knowing. Real availability,
              fair prices, restraint over noise.
            </p>
          </div>

          <nav className="flex flex-col gap-2 md:items-end">
            <FooterLink href="/search">Search experiences</FooterLink>
