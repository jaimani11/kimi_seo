 ...
 *
 * When live Viator inventory is unavailable, the days still render
...
export function ItinerarySeoPage({
  ...
  return (
    ...
    >
      ...
      {/* GetYourGuide widget — itinerary-shaped campaign tag so per-
        * duration CTR is comparable in the GYG partner dashboard. */}
      <GygActivitiesWidget
      ...
      {plan ? (
        <section className="mx-auto max-w-6xl px-6 pt-4 pb-12 md:pt-6">
          ...
          >
            Affiliate links to Viator. Same price as direct. Commission keeps numiworks free.
          </p>
        </section>
      ) : (
        <section className="mx-auto max-w-3xl px-6 pb-16">
          ...
          >
            {loadError
              ...
              : `Live Viator inventory hasn’t been configured for this environment yet. The day-by-day frame is in place; bookable picks will populate once VIATOR_API_KEY is set.`}
          </p>
        </section>
      )}
    </SeoPageShell>
...
export function buildItineraryJsonLd({
  ...
  const payload = {
    ...
    itinerary,
    url: canonical,
    image: 'https://numiworks.com/og-default.png',
    provider: {
      '@type': 'Organization',
      name: 'numiworks',
      url: 'https://numiworks.com',
    },
    location: {
      '@type': 'Place',
