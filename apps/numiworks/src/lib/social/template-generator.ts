...
const CTA_OPTIONS = [
  'Plan your trip on numiworks.com',
  'Build the itinerary at numiworks.com',
  'Free AI trip planner → numiworks.com',
  'Get the full guide on numiworks.com',
  'Bookable on Viator via numiworks.com',
];
  ...
  if (guide) {
    ...
    pins.push({
      ...
      description: guide.neighborhoods
        ...
        .join(' ')
        .slice(0, 480),
      visualConcept: `Stylized map of ${city.name} with neighborhoods highlighted in numiworks brand colors, plus a small landmark icon per neighborhood.`,
