  ...
  pinterest: [
    {
      ...
      visualConcept:
        'Aerial of Shibuya Crossing at dusk with neon trails, overlay text "3 DAYS IN TOKYO" in numiworks coral.',
      hashtags: ['#tokyo', '#tokyotravel', '#japan', '#3dayitinerary', '#numiworks'],
      cta: 'Plan your 3-day Tokyo trip free on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoitinerary', '#japantravel', '#5days', '#numiworks'],
      cta: 'Get the 5-day plan on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoweek', '#japan', '#7dayitinerary', '#numiworks'],
      cta: 'Build your week-long Tokyo plan on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#cherryblossom', '#travelplanning', '#numiworks'],
      cta: 'See the full Tokyo seasonal guide on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#budgettravel', '#japanbudget', '#travelhacks', '#numiworks'],
      cta: 'Compare Tokyo budgets on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#foodie', '#numiworks'],
      cta: 'Get the Tokyo food map free on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      visualConcept:
        'Stylized Tokyo map with four neighborhoods highlighted in numiworks brand colors, each with an icon.',
      hashtags: ['#tokyo', '#wheretostay', '#tokyohotels', '#neighborhoodguide', '#numiworks'],
      cta: 'Compare Tokyo neighborhoods on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#familytravel', '#tokyowithkids', '#travelwithkids', '#numiworks'],
      cta: 'Plan your Tokyo family trip on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#tokyoweekend', '#numiworks'],
      cta: 'Plan a Tokyo couples weekend on numiworks.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#solotravel', '#solofemaletravel', '#tokyosolo', '#numiworks'],
      cta: 'Plan your solo Tokyo trip on numiworks.com',
    },
  ],
  tiktok: [
    {
      ...
      cta: 'Save this and plan free on numiworks.com — link in bio.',
      durationSec: 22,
    ...
    },
    {
      ...
      cta: 'Free Tokyo day-1 plan at numiworks.com — link in bio.',
      durationSec: 26,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyo', '#tokyovlog', '#japan', '#travelpov', '#dayinthelife', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Compare them in detail on numiworks.com — link in bio.',
      durationSec: 24,
      musicCue: 'high-energy electronic, festival vibe',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#wheretostay', '#tokyohotels', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Pick your tier on numiworks.com — link in bio.',
      durationSec: 20,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#tokyobudget', '#budgettravel', '#travelmoney', '#japan', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Save this crawl. Link in bio — numiworks.com.',
      durationSec: 28,
      musicCue: 'upbeat j-pop instrumental',
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#streetfood', '#foodcrawl', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the solo Tokyo plan on numiworks.com — link in bio.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#tokyo', '#solotravel', '#tokyosolo', '#solofemaletraveler', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Family Tokyo plan free on numiworks.com — link in bio.',
      durationSec: 22,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelwithkids', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Plan + book on numiworks.com — link in bio.',
      durationSec: 18,
      musicCue: 'tense uplifting electronic',
      hashtags: ['#tokyo', '#travelplanning', '#tokyohacks', '#traveltips', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the perfect Tokyo day on numiworks.com — link in bio.',
      durationSec: 20,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#tokyonight', '#tokyodawn', '#travelvideo', '#numiworks'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get smart Tokyo tips on numiworks.com — link in bio.',
      durationSec: 22,
      musicCue: 'punchy lo-fi with vocal sample',
      hashtags: ['#tokyo', '#travelmistakes', '#tokyotips', '#travelhacks', '#numiworks'],
    },
  ],
  reels: [
    {
      ...
      cta: 'Full Tokyo plan on numiworks.com.',
      durationSec: 28,
      musicCue: 'dreamy indie-pop, mid-tempo',
      hashtags: ['#tokyo', '#tokyoreels', '#japan', '#travelreels', '#travelinspo', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo food map on numiworks.com.',
      durationSec: 26,
      musicCue: 'jazzy lounge, food-show energy',
      hashtags: ['#tokyofood', '#japanfood', '#foodreels', '#tokyoeats', '#foodie', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'See the full seasonal guide on numiworks.com.',
      durationSec: 18,
    ...
    },
    {
      ...
      durationSec: 22,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyohotels', '#wheretostay', '#tokyoneighborhoods', '#travelreels', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Plan the perfect Tokyo Sunday on numiworks.com.',
      durationSec: 30,
      musicCue: 'mellow jazz, café ambience',
      hashtags: ['#tokyo', '#tokyovlog', '#travelreels', '#sundayintokyo', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Family Tokyo plan on numiworks.com.',
      durationSec: 24,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelreels', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Romantic Tokyo weekend on numiworks.com.',
      durationSec: 26,
      musicCue: 'soft piano, romantic',
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#travelreels', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Solo Tokyo plan on numiworks.com.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#solofemaletravel', '#tokyosolo', '#solotravel', '#travelreels', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo prep checklist on numiworks.com.',
      durationSec: 18,
      musicCue: 'punchy lo-fi',
      hashtags: ['#tokyo', '#packingtips', '#travelpacking', '#travelreels', '#numiworks'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Save and plan on numiworks.com.',
      durationSec: 22,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#goldenhour', '#tokyoview', '#travelreels', '#travelinspo', '#numiworks'],
    },
  ],
  shorts: [
    {
      ...
      cta: 'Get the full 3-day Tokyo plan free on numiworks.com.',
      durationSec: 28,
      musicCue: 'uplifting cinematic electronic',
      hashtags: ['#tokyo', '#tokyoitinerary', '#travelshorts', '#japanshorts', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Budget Tokyo plan free on numiworks.com.',
      durationSec: 22,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#budgettravel', '#travelshorts', '#tokyobudget', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pick your Tokyo neighborhood on numiworks.com.',
      durationSec: 24,
      musicCue: 'punchy upbeat lo-fi',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#travelshorts', '#japan', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#travelmistakes', '#travelshorts', '#tokyotips', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Full Tokyo food map on numiworks.com.',
      durationSec: 26,
      musicCue: 'food-show jazzy lounge',
      hashtags: ['#tokyofood', '#tokyo', '#travelshorts', '#japanfood', '#foodtok', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#travelshorts', '#travelplanning', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Book a Tokyo day trip on numiworks.com.',
      durationSec: 22,
      musicCue: 'uplifting cinematic',
      hashtags: ['#tokyo', '#daytrips', '#travelshorts', '#hakone', '#kamakura', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Free Tokyo plan on numiworks.com.',
      durationSec: 18,
      musicCue: 'punchy uplifting electronic',
      hashtags: ['#tokyo', '#freetokyo', '#budgettravel', '#travelshorts', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Local Tokyo food guide on numiworks.com.',
      durationSec: 18,
      musicCue: 'mellow lo-fi',
      hashtags: ['#tokyofood', '#localtokyo', '#travelshorts', '#tokyo', '#numiworks'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pre-flight Tokyo checklist on numiworks.com.',
      durationSec: 20,
      musicCue: 'punchy productivity beat',
      hashtags: ['#tokyo', '#travelapps', '#travelshorts', '#travelprep', '#numiworks'],
    },
  ],
};
