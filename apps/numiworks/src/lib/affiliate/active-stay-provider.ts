 ...
 *
 * Active default: `viator`. numiworks is a Viator-affiliate platform;
...
const DEFAULT_PROVIDER: ActiveStayProvider = 'viator';
...
export function buildActiveStaySearchUrl(input: ActiveStaySearchInput): string {
  ...
  // what numiworks monetizes. Date/traveler context lives in the
