...
export const metadata: Metadata = {
  title: 'Terms of Service · numiworks',
  description: 'The terms governing your use of numiworks.com.',
  alternates: { canonical: 'https://www.numiworks.com/terms' },
};
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        <header className="mb-10">
          ...
          >
            The agreement between you and numiworks when you use this site.
          </p>
        </header>

        <Section title="1. About numiworks">
          <P>
            Numiworks is a travel-planning website that helps you discover destinations and book
        ...
        <Section title="3. What you can do">
          <ul style={ulStyle}>
            ...
            <Li>
              Click through to Viator and other partner sites to book experiences. Bookings happen
        ...
        <Section title="4. What you can't do">
          <ul style={ulStyle}>
            ...
            <Li>Impersonate numiworks or its operators.</Li>
          </ul>
        </Section>

        <Section title="5. Bookings happen with partners">
          <P>
            When you click a &ldquo;Reserve on Viator&rdquo; or similar CTA, you leave numiworks
        ...
        <Section title="7. Intellectual property">
          <P>
            Numiworks owns or licenses everything on this site (text, photos, illustrations,
        ...
        <Section title="9. Disclaimer + limitation of liability">
          <P>
            To the maximum extent permitted by law, numiworks is not liable for indirect,
        ...
        <Section title="10. Indemnification">
          <P>
            You agree to indemnify and hold numiworks harmless from any claim arising out of your
