...
export const metadata: Metadata = {
  title: 'Privacy Policy · numiworks',
  description:
    'How numiworks collects, uses, and shares information when you use our travel-planning service.',
  alternates: { canonical: 'https://www.numiworks.com/privacy' },
};
 ...
 * what numiworks actually does with their data.
 *
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        ...
        <Section title="1. Who we are">
          <P>
            Numiworks (&ldquo;numiworks&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) operates the
        ...
        <Section title="2. Information we collect">
          ...
          <ul style={ulStyle}>
            ...
            <Li>
              <strong>Affiliate click log.</strong> When you click a &ldquo;Reserve on Viator&rdquo;
        ...
        <Section title="4. Third parties we share with">
          ...
          <ul style={ulStyle}>
            <Li>
              ...
              under their own privacy policy. We do not share your numiworks account information
              with them.
            </Li>
            <Li>
            ...
            <Li>
              ...
              trackers on our pages, and clicking a numiworks link on those platforms simply opens
        ...
        <Section title="7. Children">
          <P>
            Numiworks is not directed at children under 13 (or under 16 in the EU). We do not
        ...
        <Section title="9. International transfers">
          <P>
            Numiworks is operated globally and your data may be processed in the United States,
        ...
        <Section title="11. Contact">
          <P>
            ...
            <a
              href="mailto:privacy@numiworks.com"
              style={{ color: 'var(--accent-primary)' }}
            >
              privacy@numiworks.com
            </a>
