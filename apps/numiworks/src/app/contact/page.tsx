...
export const metadata: Metadata = {
  title: 'Contact numiworks',
  description:
    'Contact numiworks. Media enquiries, partnership questions, feedback on the site — send a message via the form and we respond within 2 business days.',
};
    ...
    <>
      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        >
          ...
          If you already booked a stay/flight/car through Viator and need
          to change or cancel, contact Viator support directly at{' '}
          <a
            href="https://help.viator.com"
            target="_blank"
