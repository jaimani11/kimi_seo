...
export const metadata: Metadata = {
  title: 'Privacy Policy · stayviaowner',
  description:
    'How stayviaowner collects, uses, and shares information when you use our travel-planning service.',
  alternates: { canonical: 'https://www.stayviaowner.com/privacy' },
};
 ...
 * what stayviaowner actually does with their data.
 *
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        ...
        <Section title="4. Third parties we share with">
          ...
          <ul style={ulStyle}>
            <Li>
              ...
              under their own privacy policy. We do not share your stayviaowner account information
              with them.
            </Li>
            <Li>
            ...
            <Li>
              ...
              trackers on our pages, and clicking a stayviaowner link on those platforms simply opens
        ...
        <Section title="11. Contact">
          <P>
            ...
            <a
              href="mailto:privacy@stayviaowner.com"
              style={{ color: 'var(--accent-primary)' }}
            >
              privacy@stayviaowner.com
            </a>
