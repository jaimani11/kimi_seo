...
export const metadata: Metadata = {
  title: 'Terms of Service · stayviaowner',
  description: 'The terms governing your use of stayviaowner.com.',
  alternates: { canonical: 'https://www.stayviaowner.com/terms' },
};
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        <header className="mb-10">
          ...
          >
            The agreement between you and stayviaowner when you use this site.
          </p>
        </header>
        ...
        <Section title="4. What you can't do">
          <ul style={ulStyle}>
            ...
            <Li>Impersonate stayviaowner or its operators.</Li>
          </ul>
        </Section>
        ...
        <Section title="9. Disclaimer + limitation of liability">
          <P>
            To the maximum extent permitted by law, stayviaowner is not liable for indirect,
        ...
        <Section title="10. Indemnification">
          <P>
            You agree to indemnify and hold stayviaowner harmless from any claim arising out of your
        ...
        <Section title="13. Contact">
          <P>
            ...
            <a href="mailto:hello@stayviaowner.com" style={{ color: 'var(--accent-primary)' }}>
              hello@stayviaowner.com
            </a>
            .
          </P>
        </Section>
