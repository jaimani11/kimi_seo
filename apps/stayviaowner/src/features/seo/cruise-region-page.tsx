...
> = {
  mediterranean: {
    ...
    intro:
      "Sailing the Med? Lock in your pre-cruise night at the embarkation port — Barcelona, Civitavecchia (Rome), Athens (Piraeus), or Venice. Walk onboard rested, not airport-tired. Every major Vrbo hotel in each port city.",
    bullets: [
      'Hotels at every major Western & Eastern Med embarkation port',
      'Book early, decide later',
  ...
  caribbean: {
    ...
    bullets: [
      ...
      'Flexible if your cruise rebooks',
  ...
  alaska: {
    ...
    intro:
      "Alaska cruises embark from Seattle (round-trip Inside Passage) or Vancouver (one-way Gulf of Alaska). Both port cities deserve a night or two on either end — Seattle's Pike Place, Vancouver's seawall + Stanley Park. Vrbo hotels at both.",
    bullets: [
  ...
  asia: {
    ...
    intro:
      "Asia cruises typically embark from Singapore, Hong Kong, or Yokohama (Tokyo). Each is a destination in its own right — most travelers extend their cruise with 2-3 nights in the embarkation city. Vrbo lists every major hotel near each port.",
    bullets: [
