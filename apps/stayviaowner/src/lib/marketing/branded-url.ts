/**
 * Branded stayviaowner.com URLs for social-content CTAs.
 *
 * Every post that goes out on Pinterest, Instagram, or TikTok must
 * route back to stayviaowner.com — both for brand presence and for
...
const ORIGIN = 'https://www.stayviaowner.com';
...
/**
 * Compact label used inside CTA copy ("Plan it on stayviaowner.com").
 ...
 */
export const STAYVIAOWNER_DOMAIN_LABEL = 'stayviaowner.com';
