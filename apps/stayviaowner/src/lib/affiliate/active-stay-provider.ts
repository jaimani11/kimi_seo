 ...
 *
 * Active default: `viator`. stayviaowner is a Viator-affiliate platform;
...
// stayviaowner: default flipped to 'expedia' — every stay-CTA on the
...
export function buildActiveStaySearchUrl(input: ActiveStaySearchInput): string {
  ...
  // what stayviaowner monetizes. Date/traveler context lives in the
