 ...
 * outbound link on stayviaowner belongs in the Viator ecosystem.
 *
 ...
 * is what stayviaowner is actually monetizing.
 *
 * Affiliate model:
 *
 ...
 *     by surface (we use a fixed `stayviaowner-stay` so stay-CTA clicks
...
/**
 * Default mcid. Surfaces the click as coming from a stayviaowner "stay"
 ...
 */
const DEFAULT_MCID = 'stayviaowner-stay';
 ...
 *     text=Agra&pid=PARTNER&mcid=stayviaowner-stay&medium=link
 *
