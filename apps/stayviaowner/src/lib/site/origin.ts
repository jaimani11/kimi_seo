import { STAYVIAOWNER, buildSiteJsonLd } from '@adored/brand-config';
...
export function getSiteOrigin(): string {
  ...
  return stripTrailing(STAYVIAOWNER.siteUrl);
}
...
export function siteJsonLd(): string {
  return buildSiteJsonLd(STAYVIAOWNER, getSiteOrigin());
}
