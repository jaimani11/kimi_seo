...
import { mapBookingHotel } from '@/providers/expedia/mapper';
import type { ExpediaHotel } from '@/providers/expedia/types';

function fixtureHotel(overrides: Partial<ExpediaHotel> = {}): ExpediaHotel {
  return {
    hotel_id: 12345,
...
describe('mapBookingHotel', () => {
  it('maps required fields to Stay shape', () => {
    ...
    expect(stay.id).toBe('expedia:12345');
