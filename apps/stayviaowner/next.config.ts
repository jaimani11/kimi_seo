...
// can't break the Leaflet/OSM maps, affiliate widgets, Plausible, GTM, or
// pixels. Flip the header key to "Content-Security-Policy" to enforce once a
// violation check comes back clean.
