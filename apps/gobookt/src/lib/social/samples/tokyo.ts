  ...
  pinterest: [
    {
      ...
      cta: 'Plan your 3-day Tokyo trip free on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoitinerary', '#japantravel', '#5days', '#gobookt'],
      cta: 'Get the 5-day plan on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyoweek', '#japan', '#7dayitinerary', '#gobookt'],
      cta: 'Build your week-long Tokyo plan on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#cherryblossom', '#travelplanning', '#gobookt'],
      cta: 'See the full Tokyo seasonal guide on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#budgettravel', '#japanbudget', '#travelhacks', '#gobookt'],
      cta: 'Compare Tokyo budgets on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#foodie', '#gobookt'],
      cta: 'Get the Tokyo food map free on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      visualConcept:
        'Stylized Tokyo map with four neighborhoods highlighted in gobookt brand colors, each with an icon.',
      hashtags: ['#tokyo', '#wheretostay', '#tokyohotels', '#neighborhoodguide', '#gobookt'],
      cta: 'Compare Tokyo neighborhoods on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#familytravel', '#tokyowithkids', '#travelwithkids', '#gobookt'],
      cta: 'Plan your Tokyo family trip on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#tokyoweekend', '#gobookt'],
      cta: 'Plan a Tokyo couples weekend on gobookt.com',
    },
    {
      platform: 'pinterest',
      ...
      hashtags: ['#tokyo', '#solotravel', '#solofemaletravel', '#tokyosolo', '#gobookt'],
      cta: 'Plan your solo Tokyo trip on gobookt.com',
    },
  ],
  tiktok: [
    {
      ...
      cta: 'Save this and plan free on gobookt.com — link in bio.',
      durationSec: 22,
    ...
    },
    {
      ...
      cta: 'Free Tokyo day-1 plan at gobookt.com — link in bio.',
      durationSec: 26,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyo', '#tokyovlog', '#japan', '#travelpov', '#dayinthelife', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Compare them in detail on gobookt.com — link in bio.',
      durationSec: 24,
      musicCue: 'high-energy electronic, festival vibe',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#wheretostay', '#tokyohotels', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Pick your tier on gobookt.com — link in bio.',
      durationSec: 20,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#tokyobudget', '#budgettravel', '#travelmoney', '#japan', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Save this crawl. Link in bio — gobookt.com.',
      durationSec: 28,
      musicCue: 'upbeat j-pop instrumental',
      hashtags: ['#tokyo', '#tokyofood', '#japanfood', '#streetfood', '#foodcrawl', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the solo Tokyo plan on gobookt.com — link in bio.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#tokyo', '#solotravel', '#tokyosolo', '#solofemaletraveler', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Family Tokyo plan free on gobookt.com — link in bio.',
      durationSec: 22,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelwithkids', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Plan + book on gobookt.com — link in bio.',
      durationSec: 18,
      musicCue: 'tense uplifting electronic',
      hashtags: ['#tokyo', '#travelplanning', '#tokyohacks', '#traveltips', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get the perfect Tokyo day on gobookt.com — link in bio.',
      durationSec: 20,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#tokyonight', '#tokyodawn', '#travelvideo', '#gobookt'],
    },
    {
      platform: 'tiktok',
      ...
      cta: 'Get smart Tokyo tips on gobookt.com — link in bio.',
      durationSec: 22,
      musicCue: 'punchy lo-fi with vocal sample',
      hashtags: ['#tokyo', '#travelmistakes', '#tokyotips', '#travelhacks', '#gobookt'],
    },
  ],
  reels: [
    {
      ...
      cta: 'Full Tokyo plan on gobookt.com.',
      durationSec: 28,
      musicCue: 'dreamy indie-pop, mid-tempo',
      hashtags: ['#tokyo', '#tokyoreels', '#japan', '#travelreels', '#travelinspo', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo food map on gobookt.com.',
      durationSec: 26,
      musicCue: 'jazzy lounge, food-show energy',
      hashtags: ['#tokyofood', '#japanfood', '#foodreels', '#tokyoeats', '#foodie', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'See the full seasonal guide on gobookt.com.',
      durationSec: 18,
    ...
    },
    {
      ...
      durationSec: 22,
      musicCue: 'cinematic ambient with light percussion',
      hashtags: ['#tokyohotels', '#wheretostay', '#tokyoneighborhoods', '#travelreels', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Plan the perfect Tokyo Sunday on gobookt.com.',
      durationSec: 30,
      musicCue: 'mellow jazz, café ambience',
      hashtags: ['#tokyo', '#tokyovlog', '#travelreels', '#sundayintokyo', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Family Tokyo plan on gobookt.com.',
      durationSec: 24,
      musicCue: 'cheerful uplifting indie',
      hashtags: ['#tokyo', '#tokyowithkids', '#familytravel', '#travelreels', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Romantic Tokyo weekend on gobookt.com.',
      durationSec: 26,
      musicCue: 'soft piano, romantic',
      hashtags: ['#tokyo', '#romanticgetaway', '#couplestravel', '#travelreels', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Solo Tokyo plan on gobookt.com.',
      durationSec: 22,
      musicCue: 'mellow lo-fi with light synths',
      hashtags: ['#solofemaletravel', '#tokyosolo', '#solotravel', '#travelreels', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Tokyo prep checklist on gobookt.com.',
      durationSec: 18,
      musicCue: 'punchy lo-fi',
      hashtags: ['#tokyo', '#packingtips', '#travelpacking', '#travelreels', '#gobookt'],
    },
    {
      platform: 'instagram-reels',
      ...
      cta: 'Save and plan on gobookt.com.',
      durationSec: 22,
      musicCue: 'cinematic ambient strings',
      hashtags: ['#tokyo', '#goldenhour', '#tokyoview', '#travelreels', '#travelinspo', '#gobookt'],
    },
  ],
  shorts: [
    {
      ...
      cta: 'Get the full 3-day Tokyo plan free on gobookt.com.',
      durationSec: 28,
      musicCue: 'uplifting cinematic electronic',
      hashtags: ['#tokyo', '#tokyoitinerary', '#travelshorts', '#japanshorts', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Budget Tokyo plan free on gobookt.com.',
      durationSec: 22,
      musicCue: 'jazzy upbeat lounge',
      hashtags: ['#tokyo', '#budgettravel', '#travelshorts', '#tokyobudget', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pick your Tokyo neighborhood on gobookt.com.',
      durationSec: 24,
      musicCue: 'punchy upbeat lo-fi',
      hashtags: ['#tokyo', '#tokyoneighborhoods', '#travelshorts', '#japan', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#travelmistakes', '#travelshorts', '#tokyotips', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Full Tokyo food map on gobookt.com.',
      durationSec: 26,
      musicCue: 'food-show jazzy lounge',
      hashtags: ['#tokyofood', '#tokyo', '#travelshorts', '#japanfood', '#foodtok', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      hashtags: ['#tokyo', '#besttimetovisit', '#travelshorts', '#travelplanning', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Book a Tokyo day trip on gobookt.com.',
      durationSec: 22,
      musicCue: 'uplifting cinematic',
      hashtags: ['#tokyo', '#daytrips', '#travelshorts', '#hakone', '#kamakura', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Free Tokyo plan on gobookt.com.',
      durationSec: 18,
      musicCue: 'punchy uplifting electronic',
      hashtags: ['#tokyo', '#freetokyo', '#budgettravel', '#travelshorts', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Local Tokyo food guide on gobookt.com.',
      durationSec: 18,
      musicCue: 'mellow lo-fi',
      hashtags: ['#tokyofood', '#localtokyo', '#travelshorts', '#tokyo', '#gobookt'],
    },
    {
      platform: 'youtube-shorts',
      ...
      cta: 'Pre-flight Tokyo checklist on gobookt.com.',
      durationSec: 20,
      musicCue: 'punchy productivity beat',
      hashtags: ['#tokyo', '#travelapps', '#travelshorts', '#travelprep', '#gobookt'],
    },
  ],
};
