 ...
 * route to Booking.com via the right vertical (hotels, flights, cars,
 * attractions, cruises).
 *
...
// Booking.com vertical landings (one per city).
...
// Hotel-themed sub-shapes — each routes to Booking.com hotels with a
...
// Things-to-do themed sub-shapes — these route to Booking.com
...
export function parseSeoSlug(slug: string): SeoRouteMatch | null {
  ...
  // Booking.com base verticals (one per city).
