 ...
 * gobookt. Each ranks for its category-level search intent
 * ("luxury villas Italy", "log cabin rentals Colorado") and funnels
 * clicks to Booking.com inventory.
 *
 ...
 * Until then, they live inside gobookt so we don't spread SEO
...
export interface AccommodationCategory {
  ...
  intro: string;
  /** Search anchor to use on Booking.com/Booking.com deep links. */
  searchAnchor: string;
  ...
  /** What Booking.com/Booking.com category filter maps to this landing. */
...
export const ACCOMMODATION_CATEGORIES: readonly AccommodationCategory[] = [
  {
    ...
    emoji: '🏛️',
    intro:
      'Private villa rentals — from a 2-bedroom Tuscan farmhouse to a 12-bedroom estate in Mykonos with a full staff on call. Every villa on gobookt is bookable through Booking.com, with real photos, verified guest reviews. Best-fit destinations: Italy (Tuscany, Puglia, Amalfi), Greek islands, Bali, Provence, and the Caribbean.',
    searchAnchor: 'villa',
    topCitySlugs: [
      'santorini',
      'mykonos',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Most Booking.com villas include end-of-stay cleaning in the rate. Concierge, chef, and daily housekeeping are usually add-ons — clearly listed on the property page. Larger villas (8+ bedrooms) often bundle a full staff.',
      },
      {
    ...
    faqs: [
      {
        ...
        a: 'In North America, "cabin" usually means a rustic wooden home in the mountains or woods. In the Alps, the same shape is called a "chalet" — often larger, with ski-in/ski-out access. Both are on Booking.com; they overlap heavily.',
      },
      {
        q: 'Do cabins have wifi?',
        a: 'Most modern cabins do — but rural cabins in national forests or deep in the Rockies may not. Check the property amenities list; the top-rated cabins on Booking.com clearly disclose wifi speed.',
      },
      {
      ...
      },
      {
        ...
        a: 'Roughly 40–60% of cabins on Booking.com are pet-friendly — filter for "Pets allowed" in your search. Cleaning fees are usually $50–100 higher for pet stays.',
      },
      {
  ...
  },
  {
    ...
    emoji: '🏡',
    intro:
      'Cottage rentals for a weekend getaway or a summer of slow living. Everything from a thatched-roof Cotswold cottage to a lakeside dock cottage in Ontario. Smaller and often cozier than a full villa or house — typically 1–3 bedrooms. Bookable through Booking.com. Best-fit destinations: England (Cotswolds, Lake District), Ireland, coastal New England, Ontario lake country, Nova Scotia.',
    ...
    faqs: [
      {
        ...
        a: 'Most cottages are 1–3 bedrooms — designed for a couple, a small family, or a quiet solo trip. Anything larger is usually classed as a "house" or "villa" on Booking.com.',
      },
      {
  ...
  },
  {
    ...
    emoji: '🏖️',
    intro:
      'Beach house rentals steps from the ocean — Outer Banks porches, Malibu decks, Amalfi terraces, or a cabana in Tulum. Every house on gobookt is bookable through Booking.com with verified guest reviews. Best-fit destinations: Outer Banks, 30A, Cape Cod, Malibu, Costa Rica, Tulum, Amalfi, Positano.',
    ...
    faqs: [
      {
        ...
        a: 'Beachfront means direct access from the property — sand or shore is at your door. Walking-distance means 5–15 minutes on foot. Read the listing carefully; Booking.com photos taken at low tide can mislead.',
      },
      {
        q: 'Are beach houses safe during hurricane season?',
        a: 'Coastal US, Caribbean, and Mexico hurricane season runs June 1–November 30. Peak risk is late August–October. Booking.com / Booking.com refunds for hurricane-related cancellations are property-specific — read the cancellation policy before booking.',
      },
      {
        q: 'Do beach houses provide beach gear?',
        a: 'Many do — beach chairs, umbrellas, coolers, boogie boards. The top-rated houses on Booking.com list beach gear in the amenities section. Otherwise, budget $30–50/day for rentals.',
      },
      {
  ...
  },
  {
    ...
    emoji: '⛷️',
    intro:
      'Ski-in / ski-out lodges and chalets in the world\'s top mountain resorts. Wood-clad interiors, hot tub after the slopes, ski room for boots + poles. Bookable through Booking.com for peak season and shoulder weeks. Best-fit destinations: Whistler, Banff, Jackson Hole, Aspen, Zermatt, St. Moritz, Chamonix, Val d\'Isère, Niseko, Hakuba.',
  ...
  },
  {
    ...
    emoji: '🛶',
    intro:
      'Lake house rentals on private docks and mountain lakes across North America, Alpine Europe, and beyond. Kayaks, pontoons, fire-pit evenings, and slow mornings on the water. Bookable through Booking.com. Best-fit destinations: Lake Tahoe, Lake George, Lake of the Ozarks, Ontario lake country, Lake Como, Lake Bled, Lake Geneva, Lake Lucerne.',
    ...
    faqs: [
      {
        ...
        a: 'Most Booking.com lake houses include a private dock, kayaks or paddleboards, life jackets for adults + kids, a fire pit, and a fully equipped kitchen. Higher-end rentals bundle a pontoon boat with the stay.',
      },
      {
      ...
      },
      {
        ...
        a: 'Kayaks + paddleboards, almost always. Motorboats + pontoons, sometimes — usually a separate line item at $200–400/day. Filter for "Boat included" in your Booking.com search.',
      },
    ],
    expediaSubcategory: 'vacation-rentals',
  },
  {
    ...
    emoji: '🌊',
    intro:
      'Beachfront and near-beach villa rentals with the space a hotel room can\'t touch — private pools, full kitchens, and the ocean a few steps away. Bookable through Booking.com with real photos and verified reviews. Best-fit destinations: Bali, the Greek islands, Phuket, the Riviera Maya, Ibiza, and the Amalfi Coast.',
  ...
  },
  {
    ...
    emoji: '🥂',
    intro:
      'The top tier of villa rentals — private chefs, daily housekeeping, infinity pools and concierge teams. These are the homes people book for milestone trips and multi-family getaways. Every property is bookable through Booking.com with verified reviews. Best-fit destinations: Santorini, Mykonos, Bali, the Côte d\'Azur, Lake Como, and Marrakech.',
  ...
  },
  {
    ...
    emoji: '🏊',
    intro:
      'Villa rentals with a private pool you never have to share — the single most-requested amenity in vacation rentals. From plunge pools in Santorini caves to 20-metre lap pools in Bali, all bookable through Booking.com. Best-fit destinations: Bali, Phuket, the Greek islands, Marrakech, and the Balearics.',
  ...
  },
  {
    ...
    emoji: '🏰',
    intro:
      'Grand estate rentals for big groups, milestone celebrations and multi-generational trips — six to twenty bedrooms, sweeping grounds, and the kind of space that turns a trip into an event. Bookable through Booking.com. Best-fit destinations: the Côte d\'Azur, Mallorca, Cape Town, Lake Como, and Marrakech.',
  ...
  },
  {
    ...
    emoji: '🎿',
    intro:
      'Alpine chalet rentals — wood-clad, cosy, and often ski-in/ski-out — with hot tubs, boot rooms and mountain views. The group ski trip done right. Bookable through Booking.com for peak season and quieter shoulder weeks. Best-fit destinations: Zermatt, St. Moritz, the Swiss Jungfrau, Whistler, and Banff.',
    searchAnchor: 'chalet',
    topCitySlugs: ['zermatt', 'st-moritz', 'grindelwald', 'wengen', 'murren', 'interlaken', 'whistler', 'banff', 'queenstown', 'lauterbrunnen'],
    faqs: [
      { q: 'What\'s the difference between a chalet and a cabin?', a: 'Both are wooden mountain homes; "chalet" is the Alpine term and usually implies ski access and a more finished, sometimes larger property. They overlap heavily on Booking.com.' },
  ...
  },
  {
    ...
    emoji: '⛺',
    intro:
      'Luxury-camping rentals — safari tents, geodesic domes, yurts and eco-cabins with real beds, proper bathrooms and often a hot tub under the stars. The outdoors without roughing it. Bookable through Booking.com. Best-fit destinations: Cape Town\'s winelands, the Marrakech desert, Queenstown, Banff, and Bali\'s jungle.',
  ...
  },
  {
    ...
    emoji: '🌾',
    intro:
      'Countryside farmhouse and finca rentals — stone walls, big kitchens, olive groves and vineyards out the window. Space to spread out and cook, at a pace the city can\'t offer. Bookable through Booking.com. Best-fit destinations: the Riviera hinterland, Mallorca, the Cape winelands, Crete, and the Marrakech countryside.',
  ...
  },
  {
    ...
    emoji: '🌆',
    intro:
      'Top-floor penthouse rentals with wraparound terraces, skyline or sea views, and space that puts a suite to shame. The city stay upgraded. Bookable through Booking.com with verified reviews. Best-fit destinations: Dubai, Nice, Cape Town, Barcelona, Miami, and New York.',
  ...
  },
  {
    ...
    emoji: '👨‍👩‍👧‍👦',
    intro:
      'Villa rentals built for families — fenced or shallow pools, bunk rooms, high chairs and cots, and gardens with room to run. A trip where the kids are happy and the adults actually relax. Bookable through Booking.com. Best-fit destinations: the Balearics, the Algarve, Crete, Bali, and the Riviera.',
  ...
  },
  {
    ...
    emoji: '🏖️',
    intro:
      'Condo and resort-apartment rentals — building pool, gym and often beach access, with a kitchen and separate bedrooms for less than a comparable hotel. The easy, well-located stay. Bookable through Booking.com. Best-fit destinations: Cancún, Tulum, Maui, Honolulu, Phuket, and Dubai.',
    searchAnchor: 'condo',
