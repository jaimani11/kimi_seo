 ...
 * gobookt's per-brand photo VARIANT (1). Every call site in this app inherits
 * it, so gobookt's hero images differ from the sibling brands for the same city
 * (anti-duplicate). gotript = variant 0 (unchanged); numiworks = 2; svo = 3.
 */
import {
