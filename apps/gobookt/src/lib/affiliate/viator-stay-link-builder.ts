 ...
 * outbound link on gobookt belongs in the Viator ecosystem.
 *
 ...
 * is what gobookt is actually monetizing.
 *
 * Affiliate model:
 *
 ...
 *     by surface (we use a fixed `gobookt-stay` so stay-CTA clicks
...
/**
 * Default mcid. Surfaces the click as coming from a gobookt "stay"
 ...
 */
const DEFAULT_MCID = 'gobookt-stay';
 ...
 *     text=Agra&pid=PARTNER&mcid=gobookt-stay&medium=link
 *
