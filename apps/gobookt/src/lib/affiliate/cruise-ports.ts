/**
 * Major cruise embarkation ports — Booking.com lost their cruise
 ...
 * the night before sailing). This list powers the gobookt Cruises
 ...
 * pass to Booking.com's hotel search as `ss=`. Booking.com's resolver
...
export interface CruisePort {
  slug: string;
  name: string;
  /** What we send to Booking.com `ss=` for hotel search. */
