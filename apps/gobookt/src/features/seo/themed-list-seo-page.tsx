...
> = {
  ...
  'first-timer': {
    ...
    intro: (c) =>
      `${c.oneLiner} The essential first-timer's hit list for ${c.name} — the sights, stays and experiences worth your limited days, all in one place.`,
  ...
  'worth-visiting': {
    ...
    intro: (c) =>
      `${c.oneLiner} A straight answer on whether ${c.name} is worth the trip — what makes it special, who'll love it, and what to see when you go.`,
  ...
  'hidden-gems': {
    ...
    intro: (c) =>
      `${c.oneLiner} The lesser-known corners of ${c.name} most tourists miss — offbeat spots and local favorites worth seeking out.`,
  ...
  instagram: {
    ...
    intro: (c) =>
      `${c.oneLiner} The most photogenic spots in ${c.name} and the viewpoints and neighborhoods that get you there at the right light.`,
  ...
  luxury: {
    ...
    intro: (c) =>
      `${c.oneLiner} The high-end side of ${c.name} — the premium stays and experiences worth the splurge.`,
  ...
  'how-many-days': {
    ...
    intro: (c) =>
      `${c.oneLiner} How long you actually need in ${c.name} — and how to fill each day, whether you have a weekend or a week.`,
    viatorQuery: (c) => `${c.viatorQuery} top attractions`,
  },
  'solo-female': {
    slugPrefix: '',
    ...
    intro: (c) =>
      `${c.oneLiner} A solo-female-friendly take on ${c.name} — safe neighborhoods, easy-to-meet-people spots, and where to base yourself.`,
  ...
  'bucket-list': {
    ...
    intro: (c) =>
      `${c.oneLiner} The once-in-a-lifetime experiences that define a ${c.name} trip — the bucket-list moments worth planning around.`,
  ...
  'private-tours': {
    ...
    intro: (c) =>
      `${c.oneLiner} Private, guide-to-yourself tours of ${c.name} — your pace, your interests, skip the crowds.`,
