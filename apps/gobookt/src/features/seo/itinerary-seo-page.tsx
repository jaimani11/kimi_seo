 ...
 *
 * When live Booking.com inventory is unavailable, the days still render
    ...
    >
      ...
      {plan ? (
        <section className="mx-auto max-w-6xl px-6 pt-4 pb-12 md:pt-6">
          ...
          >
            Affiliate links to Viator. Same price as direct. Commission keeps gobookt free.
          </p>
        </section>
      ) : (
        <section className="mx-auto max-w-3xl px-6 pb-16">
          ...
          >
            {loadError
              ? `Live Booking.com inventory is temporarily unavailable. Try again in a moment.`
              : `Live Booking.com inventory hasn’t been configured for this environment yet. The day-by-day frame is in place; bookable picks will populate once VIATOR_API_KEY is set.`}
          </p>
        </section>
      )}
    </SeoPageShell>
...
export function buildItineraryJsonLd({
  ...
  const payload = {
    ...
    itinerary,
    url: canonical,
    image: 'https://gobookt.com/og-default.png',
    provider: {
      '@type': 'Organization',
      name: 'gobookt',
      url: 'https://gobookt.com',
    },
    location: {
      '@type': 'Place',
