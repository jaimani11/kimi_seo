...
/**
 * /{region}-cruises landings — Booking.com no longer sells cruises,
...
> = {
  mediterranean: {
    ...
    intro:
      "Sailing the Med? Lock in your pre-cruise night at the embarkation port — Barcelona, Civitavecchia (Rome), Athens (Piraeus), or Venice. Walk onboard rested, not airport-tired. Every major Booking.com hotel in each port city, free cancellation on most rates.",
    bullets: [
      ...
      'Real Booking.com guest reviews from past cruise travelers',
    ],
  ...
  caribbean: {
    ...
    intro:
      "Caribbean sailings board mid-morning — fly in the day before to Miami, Fort Lauderdale, Port Canaveral, Tampa, San Juan, or Galveston. Sleep at the port, walk onto the ship at breakfast time. Booking.com lists every major hotel near each cruise terminal.",
    bullets: [
  ...
  alaska: {
    ...
    intro:
      "Alaska cruises embark from Seattle (round-trip Inside Passage) or Vancouver (one-way Gulf of Alaska). Both port cities deserve a night or two on either end — Seattle's Pike Place, Vancouver's seawall + Stanley Park. Booking.com hotels at both, free cancellation on most.",
    bullets: [
      ...
      'Real Booking.com reviews from past cruise passengers',
    ],
  ...
  'northern-europe': {
    ...
    eyebrow: 'Europe · pre & post-cruise stays',
    intro:
      "Norwegian fjord, Baltic, and British Isles cruises embark from Southampton, Copenhagen, or Bergen. The port cities are destinations in themselves — Southampton + a London side-trip, Copenhagen's harbour district, Bergen's UNESCO Bryggen wharf. Booking.com hotels at every port.",
    bullets: [
  ...
  asia: {
    ...
    intro:
      "Asia cruises typically embark from Singapore, Hong Kong, or Yokohama (Tokyo). Each is a destination in its own right — most travelers extend their cruise with 2-3 nights in the embarkation city. Booking.com lists every major hotel near each port, free cancellation on most rates.",
    bullets: [
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-10 pb-6 md:pt-16">
        ...
        {/* Port hotel grid — each links to Booking.com Hotels for the port city */}
        <section className="mt-10">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            {ports.map((port) => {
              const hotelsUrl = buildBookingComCategoryUrl('hotels', {
              ...
              return (
                ...
                >
                  ...
                  >
                    Hotels in {port.city} on Booking.com →
                  </p>
                </a>
              );
            })}
