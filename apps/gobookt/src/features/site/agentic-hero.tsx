...
export function AgenticHero() {
  ...
  return (
    ...
    >
      {/* gobookt is a Booking.com affiliate. The hero band uses
       *  Booking.com's iconic deep-navy → bright-blue gradient so the
       *  partnership reads visually at first glance — no dark
       *  cinematic photo that could be confused with a content
       *  publisher. */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center justify-center px-6 pt-20 pb-14 text-center md:pt-24 md:pb-18">
        ...
        >
          ...
          />
          Official Booking.com affiliate · AI trip planner
        </p>
        ...
        >
          ...
          search live Booking.com inventory, and surface a curated short-list with reasoning.
        </p>
...
function prettyLabel(agent: string, fallback: string | null | undefined): string {
  ...
  switch (agent) {
    ...
    case 'search':
      return 'Searching live Booking.com inventory';
    case 'mood':
