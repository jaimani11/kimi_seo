 ...
 *
 * Booking.com discontinued their consumer Cruises product, so the
 * gobookt Cruises tab is now a port-hotel discovery surface: pick
 * your embarkation port, gobookt links straight to Booking.com hotels
 ...
 *  hotel booking is where gobookt earns).  */
...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: 'Port hotels around Miami, Barcelona, Seattle and Civitavecchia sell out 2-3 months before peak season. Free-cancellation rates on Booking.com let you lock in early, then re-shop closer to sail-day if prices drop.',
  },
  {
      ...
      <section className="mx-auto max-w-5xl px-6 py-14">
        <header className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            major cruise port — all bookable through Booking.com, free cancellation on most.
          </p>
        </header>
      </section>
