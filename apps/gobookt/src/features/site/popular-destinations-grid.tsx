 ...
 * visual weight. gobookt's roster is deliberately its OWN (city-break and
 * hotel-hub cities where the question is "where do I stay?") so no two brands'
 * grids look alike; photos resolve per-city from @adored/imagery. Each tile
 * deep-links to that city's Booking.com accommodation page (/hotels-in-{city}),
 * NOT an editorial guide — that's gobookt's commercial job. No fabricated
 * prices/ratings/counts — evidence-safe.
 */

const ROSTER: readonly string[] = [
  'dubai', 'singapore', 'bangkok', 'hong-kong', 'las-vegas', 'orlando',
  'miami', 'doha', 'kuala-lumpur', 'abu-dhabi', 'madrid', 'berlin',
];
