...
export function buildConciergeNote(rawQuery: string): BuiltNote | null {
  ...
  return {
    body: 'Live Booking.com inventory below — every card is bookable today. Tighten the search with a city name or a vibe, or let the planner build a day-by-day around it.',
    planQuery: query,
    suggestedNights: 3,
    planVerb: 'day around it',
  };
